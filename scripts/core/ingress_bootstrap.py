...
BOOTSTRAP_PROFILES: tuple[IngressBootstrapProfile, ...] = (
    ...
    IngressBootstrapProfile(
        ...
        local_base_path="/v1beta/openai",
        default_model="gemini-2.5-flash",
        api_key_env="GEMINI_API_KEY",
        notes="Official Gemini OpenAI-compatibility profile for IDE capture via the local ingress companion.",
    ),
    IngressBootstrapProfile(
        ...
        notes="Official OpenRouter profile using the OpenAI-compatible API path.",
    ),
    IngressBootstrapProfile(
        ...
        notes="Perplexity Sonar uses an OpenAI-compatible root base URL, so the local companion also stays on the root path.",
    ),
    IngressBootstrapProfile(
        profile_id="xai",
        ...
        notes="Official xAI profile for Grok-compatible OpenAI tooling.",
    ),
    IngressBootstrapProfile(
        profile_id="mistral",
        ...
        notes="Official Mistral OpenAI SDK profile for IDE or CLI ingress capture.",
    ),
    IngressBootstrapProfile(
        profile_id="stepfun",
        ...
        provider="stepfun",
        protocol="openai",
        upstream_base_url="https://api.stepfun.ai/v1",
        local_base_path="/v1",
        default_model="step-1v-8k",
        api_key_env="STEPFUN_API_KEY",
        notes="Official StepFun OpenAI-compatible profile for IDE or CLI ingress capture.",
    ),
    IngressBootstrapProfile(
        profile_id="qwen",
        ...
        local_base_path="/compatible-mode/v1",
        default_model="qwen3-coder-plus",
        api_key_env="DASHSCOPE_API_KEY",
        notes="Official DashScope OpenAI-compatible profile for Qwen IDE capture; Coding Plan users can override the upstream base URL if their workspace uses a dedicated coding endpoint.",
    ),
    IngressBootstrapProfile(
        profile_id="kimi",
        ...
        notes="Official Moonshot OpenAI-compatible profile for Kimi IDE or CLI ingress capture.",
    ),
    IngressBootstrapProfile(
        profile_id="glm",
        ...
        local_base_path="/api/coding/paas/v4",
        default_model="glm-4.7",
        api_key_env="BIGMODEL_API_KEY",
        notes="Official BigModel coding endpoint profile for GLM IDE or coding CLI ingress capture.",
    ),
    IngressBootstrapProfile(
        profile_id="doubao",
        ...
        local_base_path="/api/v3",
        default_model="doubao-seed-1-6-251015",
        api_key_env="ARK_API_KEY",
        notes="Official Volcengine Ark profile for Doubao-compatible IDE or CLI ingress capture.",
    ),
    IngressBootstrapProfile(
        profile_id="minimax",
        ...
        notes="Official MiniMax OpenAI-compatible profile for IDE or CLI ingress capture.",
    ),
    IngressBootstrapProfile(
...
def build_ingress_bootstrap_payload(
    *,
    ...
    config: IngressCompanionConfig = build_ingress_companion_config(
        ...
        local_base_path=local_base_path if local_base_path is not None else profile.local_base_path,
        log_root=log_root,
